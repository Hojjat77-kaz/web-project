...
if(!isset($_COOKIE['login_admin'])) {
  ...
  if(isset($_POST['submit'])){
    ...
    $stmt_c = $conn->prepare("SELECT count(*) as c FROM `admin` WHERE  `user_name`= :user_name and `password`=:password;");
    ...
    if( $row_count['c'] ){
        ...
        setcookie('login_admin', $code_cookie, time() + (86400 * 30), "/");

        $stmt = $conn->prepare("UPDATE `admin` SET `login_code`= :login_code WHERE `user_name` = :user_name and `password` = :password");
            ...
            <div class="col-12 col-lg-6 order-2 position-relative d-flex align-items-center bg-1">
                ...
                <div class="login-content text-center text-lg-left">
                    ...
                    <div class="title d-inline-block mb-4">
                        <h3 class="mb-3 heading" > ورود ادمین سایت نام کاربری و رمز admin عبور پیش فرض </h3>
                    </div>
                    ...
                    <form method="post" action="">
                        ...
                        <input class="form-control" type="password" name="password" placeholder="رمز عبور" required="">
                            ...
                            <button name="submit" type="submit" class="btn btn-large rounded-pill main-btn">ورود ادمین</button>
                ...
                <div class="bottom-mini-nav">
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-12 simple-navbar d-flex align-items-center justify-content-start">
                            <nav class="navbar">
                                <a class="nav-link link" href="index.php">خانه</a></a>d</a>
