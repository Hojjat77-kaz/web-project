            ...
            <div class="col-12 col-lg-6 order-2 position-relative d-flex align-items-center bg-1">
                ...
                <div class="login-content text-center text-lg rtl">
                    ...
                    <div class="title d-inline-block mb-4">
                        <h3 class="mb-3 heading">ورود کاربر</h3>
                        <p class="text">در صورتی که قبلا ثبت نام نکرداید ابتدا باید ثبت نام کنید</p>
                    </div>
                    ...
                    <form method="post" action="" class="rtl">
                        ...
                        <input class="form-control" type="password" name="password" placeholder="رمز عبور" required="">
                            ...
                            <button name="submit" type="submit" class="btn btn-large rounded-pill main-btn">ورود</button>
                            <a href="registeration.php" class="text">هنوز ثبت نام نکرده ام</a>
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-12 simple-navbar d-flex align-items-center justify-content-start">
                            <nav class="navbar rtl">
                                ...
                                <a class="nav-link link"  href="login_admin.php">ورود به پنل مدیریت</a>
                            </nav>
                        </div>
                    </div>
                </div>
